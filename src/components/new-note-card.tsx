          ...
          <form className="flex-1 flex flex-col">
            <div className="flex flex-1 flex-col gap-3 p-5 ">
              ...
              {shouldShowOnboarding ? (
                ...
                <textarea
                  autoFocus
                  className="text-sn leading-6 text-slate-50 bg-transparent resize-none flex-1 outline-none"
            ...
            {isRecording ? (
              <button
                className="flex items-center justify-center gap-2 w-full bg-slate-900 py-4 text-center text-sm text-slate-300 outline-none font-medium "
                type="button"
